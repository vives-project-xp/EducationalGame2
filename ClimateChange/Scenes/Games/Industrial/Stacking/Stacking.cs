...
public partial class Stacking : Node2D
{
	...
	partial class StackingBlock : TextureRect
	{
		...
		private void SetTexture()
		{
			...
			if (id == 1)
			{
				Texture = GD.Load<Texture2D>("res://Scenes/Games/Industrial/Stacking/Assets/wind-turbine-base-2.png");
			}
			else if (id == 2)
			{
				Texture = GD.Load<Texture2D>("res://Scenes/Games/Industrial/Stacking/Assets/wind-turbine-base-3.png");
			}
			else if (id == 3)
			{
				Texture = GD.Load<Texture2D>("res://Scenes/Games/Industrial/Stacking/Assets/wind-turbine-base-4.png");
			}
			else if (id == 4)
			{
				Texture = GD.Load<Texture2D>("res://Scenes/Games/Industrial/Stacking/Assets/wind-turbine-base-5.png");
			}
			else if (id == 5)
			{
				Texture = GD.Load<Texture2D>("res://Scenes/Games/Industrial/Stacking/Assets/wind-turbine-base-6.png");
			}
			else if (id == 6)
			{
				Texture = GD.Load<Texture2D>("res://Scenes/Games/Industrial/Stacking/Assets/wind-turbine-base-7.png");
			}
			else if (id == 7 && Level != PlayerHandler.StackingDificulty.Endless)
			{
				Texture = GD.Load<Texture2D>("res://Scenes/Games/Industrial/Stacking/Assets/wind-turbine-base-8.png");
			}
			else if (id == 8 && Level != PlayerHandler.StackingDificulty.Endless)
			{
				Texture = GD.Load<Texture2D>("res://Scenes/Games/Industrial/Stacking/Assets/wind-turbine-base-9.png");
			}
			else if (id == 9 && Level != PlayerHandler.StackingDificulty.Endless)
			{
				Texture = GD.Load<Texture2D>("res://Scenes/Games/Industrial/Stacking/Assets/wind-turbine-top.png");
			}
			else if (id >= 7 && Level == PlayerHandler.StackingDificulty.Endless)
			{
		...
		public override void _Process(double delta)
		{
			...
			{
				GetTree().ChangeSceneToFile("res://Scenes/Games/Industrial/Stacking/gameoverscreen.tscn");
			}
			else if (failedTimer >= 2.5 && Level == PlayerHandler.StackingDificulty.Endless)
			{
				GetTree().ChangeSceneToFile("res://Scenes/Games/Industrial/Stacking/FailedScreenEndlessMode.tscn");
			}
			if (failed)
			{
				failedTimer += delta;
			...
			if (succedTimer >= 4)
			{
				GetTree().ChangeSceneToFile("res://Scenes/Games/Industrial/Stacking/completedscreen.tscn");
			}
